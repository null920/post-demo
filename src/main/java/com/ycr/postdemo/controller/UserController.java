...
import static com.ycr.postdemo.exception.user.UserErrorCode.USER_NOT_EXIST;
import static com.ycr.postdemo.exception.user.UserErrorCode.USER_NOT_LOGIN;
...
public class UserController {
    ...
    public Result<LoginVO> login(@Valid @RequestBody UserLoginParam userLoginParam) {
        ...
        //登录
        StpUtil.login(userInfo.getUserId(), new SaLoginModel().setIsLastingCookie(userLoginParam.getRememberMe())
